...
public class modify extends javax.swing.JFrame {
   ...
   ArrayList <String> cities;
    ...
    public void setMap(Map2 map){
        this.map = map;
        Pair <Boolean,ArrayList> countries = map.arrayCountries();
        if (!countries.getKey()) {JOptionPane.showMessageDialog(null,countries.getValue());return;}
        this.countries = countries.getValue();
        for(int i = 0; i < countries.getValue().size();i++){
             comboCountry.addItem(countries.getValue().get(i).toString());
        }
        
        Pair <Boolean,ArrayList> cities = map.arrayCities();
        ...
        for(int i = 0; i < cities.getValue().size();i++){
             comboCity.addItem(cities.getValue().get(i).toString());
        }
    }
