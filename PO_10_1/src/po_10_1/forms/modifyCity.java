...
public class modifyCity extends javax.swing.JFrame {
    ...
    public void setCity(City city){
        this.city = city;
        this.textCount.setText(city.getCountry().toString());
        this.textCountryID.setText(city.getCountry().toString());
        this.textID.setText(city.getID().toString());
        this.textName.setText(city.getName());
    ...
    private void addButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addButtonMousePressed
      ...
      //   System.out.println(jComboBox1.getSelectedItem().toString() +"  "+Boolean.parseBoolean(jComboBox1.getSelectedItem().toString()));
        ...
        if (id > 0){
          ...
          String st =             map.changeCity(city, new City(textName.getText(), id,count,Boolean.parseBoolean(jComboBox1.getSelectedItem().toString()),idCountry));
